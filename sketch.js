...
function draw() {
  gif1.size(0,0);
  gif1.position(windowWidth/2 + 285, windowHeight/2-65);
  gif2.size(0,0);
  gif2.position(windowWidth/2 + 160, windowHeight/2-25);
  gif3.size(0,0);
  gif3.position(windowWidth/2 + 220, windowHeight/2-90);
  gif4.size(0,0);
  gif4.position(windowWidth/2 + 120, windowHeight/2-55);
  gif5.size(0,0);
  gif5.position(windowWidth/2 , windowHeight/2-35);
