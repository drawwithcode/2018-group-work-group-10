...
## INTERACTIONS
1.Hazy World combines two different interaction with its users. They are;
 1.WebCam; Main interactions such as cleaning the haze
 1.Mouse; Sub interactions such as swiping to next city.
